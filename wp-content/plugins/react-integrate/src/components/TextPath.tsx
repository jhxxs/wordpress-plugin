...
import { type KonvaNodeComponent, TextPath as KonvaTextPath } from "react-konva"
...
export const TextPath = forwardRef<Konva.TextPath, TextPathProps>(
  (
...
) as unknown as KonvaNodeComponent<Konva.TextPath, TextPathProps>
